...
Подробное руководство — в [docs/manual.md](docs/manual.md), ручная установка на сервер — в [docs/deploy.md](docs/deploy.md).
...
MIT — см. [LICENSE](LICENSE). Пользуйтесь, меняйте, ставьте на свои сайты, в том числе коммерческие. Автор ничего не гарантирует и ни за что не отвечает.
